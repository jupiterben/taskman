...
import { BroadCastSender } from '../mq/broadcast';

// export class Worker {
//   id: string;
//   statusReporter?: BroadCastSender;
...
//   async start() {
//     this.statusReporter = new BroadCastSender(Config.MQ_SERVER, Config.NODE_HEARTBEAT_BROADCAST);
//     this.taskResultSender = new DirectMessageSender(Config.MQ_SERVER, Config.TASK_RESULT_QUEUE);
